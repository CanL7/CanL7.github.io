...
export const siteConfig: SiteConfig = {
	title: "CanL",
	subtitle: "Blog",
	siteURL: "https://CanL-blog.top/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-3-12", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bilibili: {
		vmid: "506886354", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "Welcome to CanL Website!", // 欢迎词
		touch: [
			"What are you doing?",
			"Stop touching me!",
			"HENTAI!",
